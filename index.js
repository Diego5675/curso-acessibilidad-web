...
// Validar formulario antes de mostrar la notificacion
...
function openModal(e) {
  ...
  // Obtener la ruta de la imagen del boton
  const IMG = e.srcElement.currentSrc;
  // e.target.getAttribute("src");    // Otra manera de obtener la ruta
  document.querySelector(".modal-project-image").setAttribute("src", IMG);
